...
import { createOfferController, getAlloffersController, getOfferByIdController, updateOfferByIdController, deleteOfferByIdController, getOfferBySearchController, activateOfferByIdController } from '../controllers/offer.controller';
